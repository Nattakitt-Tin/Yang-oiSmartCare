 ...
 * ใช้เป็นตัวเลือกเสริมของระบบ Cloudflare (ตั้งค่า SHEET_URL / SHEET_SECRET) หรือใช้เดี่ยวๆ ก็ได้
 *
 * วิธีติดตั้ง: ดูไฟล์ README.md หัวข้อ "ซิงก์ไป Google Sheet ด้วย"
 */
...
// รหัสลับ ต้องตรงกับ secret SHEET_SECRET ที่ตั้งไว้ใน Cloudflare — เปลี่ยนเป็นข้อความของคุณเอง
